...
export const RocketbotInsights = () => {
  ...
  const featuredInsight = rocketbotInsights.find(insight => insight.featured);
  const regularInsights = rocketbotInsights.filter(insight => !insight.featured);

  if (rocketbotInsights.length === 0) {
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Últimas novedades <span className="text-blue-600">Rocketbot</span>
            </h2>
